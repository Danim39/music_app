...
class Form(QWidget):
    ...
    def play_music(self):
        ...
        if self.lineEdit.text() == "kerkere":
            ...
            pygame.init()
            pygame.mixer.music.load(self.music_list[74])
            pygame.mixer.music.play()

        elif self.lineEdit.text()=="hidden in the sand":
            pygame.init()
            pygame.mixer.music.load(self.music_list[75])
            pygame.mixer.music.play()

        elif self.lineEdit.text()=="formula":
            pygame.init()
            pygame.mixer.music.load(self.music_list[76])
            pygame.mixer.music.play()

        elif self.lineEdit.text()=="disney":
            pygame.init()
            pygame.mixer.music.load(self.music_list[77])
            pygame.mixer.music.play()

        elif self.lineEdit.text()=="the end":
            pygame.init()
